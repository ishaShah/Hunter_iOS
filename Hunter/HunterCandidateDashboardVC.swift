//
//  HunterCandidateDashboardVC.swift
//  Hunter
//
//  Created by Zubin Manak on 19/12/19.
...
import Cartography
class HunterCandidateDashboardVC: UIViewController {
    ...
    var colors = ["Saatchi & Saatchi", "Google"]
    var colorIndex = 0
    ...
    override func viewDidLoad() {
        ...
        let items = [fixedSpace, reloadBarButtonItem!]
        
        // Ishita
        //, flexibleSpace, leftBarButtonItem!, flexibleSpace, upBarButtonItem!, flexibleSpace, rightBarButtonItem!, flexibleSpace, downBarButtonItem!, fixedSpace]
        toolbarItems = items
    ...
    func nextCardView() -> UIView? {
        ...
        //colorForName(colors[colorIndex])
        // Ishita
        ...
        if loadCardsFromXib {
            ...
            contentView.lab_companyName.text = colors[colorIndex]
